...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Api 0x2c6 Io web application."
  #
  #
  ...
  #
  # settings.secret_key_base= pHgOFxD6ttDIyWXHlWMlI8_ZP_swB7ErY6rDgIcXx6o
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("api_0x2c6_io.log", "w"))
  #
  #
end
